...
\f0\fs24 \cf0 import HeatPumpServiceWebsite from "./HeatPumpServiceWebsite";\
\
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(34,197,94,0.15),_transparent_35%),radial-gradient(circle_at_top_right,_rgba(59,130,246,0.12),_transparent_28%),linear-gradient(180deg,_#f8fafc_0%,_#ffffff_100%)]">\
        <div className="bg-gradient-to-r from-emerald-500 via-green-500 to-lime-400 px-6 py-4 text-center shadow-lg">\
          <p className="text-base font-bold tracking-wide text-white md:text-lg">\
            ANNUAL SERVICE CONTRACTS FROM JUST <span className="text-slate-950">\'a312.50 PER MONTH</span>\
          </p>\
        </div>\
\
...
\
                  <form className="space-y-4" onSubmit=\{handleSubmit\}>\
                    ...
                    <p className="mt-3 text-sm text-slate-500 text-center">\
                      We\'92ll get back to you within 24 hours.\
                    </p>\
                  </form>\
                </CardContent>\
              </Card>\
        ...
        <div className="mx-auto max-w-7xl px-6 py-18 md:px-10">\
          <div className="max-w-3xl">\
            ...
            <p className="mt-4 text-lg text-slate-600">\
              ...
              <br />\
              <span className="font-semibold text-slate-900">From just \'a312.50 per month.</span>\
            </p>\
          </div>\
\
            ...
            <Card className="rounded-[26px] border-slate-200 shadow-sm">\
              <CardContent className="p-6">\
                ...
                <ul className="mt-4 space-y-2 text-sm text-slate-700">\
                  <li>\'95 Annual servicing visit</li>\
                  <li>\'95 System performance check</li>\
                  <li>\'95 Priority booking</li>\
                </ul>\
              </CardContent>\
            </Card>\
\
            <Card className="rounded-[26px] border-slate-200 shadow-lg border-2 relative">\
              <CardContent className="p-6">\
                ...
                <ul className="mt-4 space-y-2 text-sm text-slate-700">\
                  <li>\'95 Annual servicing visit</li>\
                  <li>\'95 Reduced call-out fees</li>\
                  <li>\'95 Priority response</li>\
                  <li>\'95 System optimisation advice</li>\
                </ul>\
              </CardContent>\
            </Card>\
\
            <Card className="rounded-[26px] border-slate-200 shadow-sm">\
              <CardContent className="p-6">\
                ...
                <ul className="mt-4 space-y-2 text-sm text-slate-700">\
                  <li>\'95 Annual servicing visit</li>\
                  <li>\'95 Priority call-outs</li>\
                  <li>\'95 Discounted repairs</li>\
                  <li>\'95 Ongoing system monitoring advice</li>\
                </ul>\
              </CardContent>\
            </Card>\
          </div>\
\
          <div className="mt-8 rounded-2xl bg-white border border-slate-200 p-6 text-center shadow-sm">\
            <p className="text-lg text-slate-700">\
              Service plans available from <span className="font-semibold">\'a312.50 per month</span>, making it easy to keep your heat pump maintained without large upfront costs.\
            </p>\
          </div>\
        </div>\
\
